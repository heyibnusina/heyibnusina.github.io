var lines = ['* About to connect() to tanyanoe.com port 443 (#0)                                 ',
'*   Trying 36.78.14.69...                                                                  ',
'* connected                                                                                   ',
'* Connected to tanyanoe.com (173.194.74.139) port 443 (#0)                                      ',
...
'* Server certificate:                                                                         ',
'* 	 subject: C=ID; ST=Jakarta; L=Jakarta View; O=tanyanoe Inc; CN=*.tanyanoe.com              ',
'* 	 start date: 2012-12-12 22:00:00 GMT                                                       ',
'* 	 expire date: 2030-12-12 22:00:00 GMT                                                      ',
'* 	 subjectAltName: tanyanoe.com matched                                                        ',
'* 	 issuer: C=US; O=tanyanoe Inc; CN=tanyanoe Internet Authority                                  ',
...
var answerStatus = false,
    ...
    answer = '',
    petitionFormat = 'noe, tolong jawab pertanyaan saya!';
...
var noeAnswers = function(answer, question){
  var tmpAnswer = '';
  if(answer.length){
...
$(function(){
  ...
  if($.cookie('terminalSeen') !== 'yes'){
    ...
    $('#terminal').queue(function(){
      ...
      $('#noe, #twitter, .quote, #how-to, .img').fadeIn();
    ...
    if(e.which == 63){
      ...
      $answer.fadeIn(function(){
          ...
          $answer.animate({
            ...
            $('#text', $answer)
              .css('display', 'none')
              .html('<span>Noe Menjawab</span>"'+noeAnswers(answer, question)+'"')
              .fadeIn();
